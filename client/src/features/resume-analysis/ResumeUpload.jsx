...
const ResumeUpload = ({ onProcessed }) => {
  ...
  const roles = [
    { value: '', label: 'Auto-detect from Resume (Recommended)' },
    { value: 'Frontend Developer', label: 'Frontend Developer (React/Angular/Vue)' },
    { value: 'Backend Developer', label: 'Backend Developer (Node/Python/Go)' },
    { value: 'Fullstack Developer', label: 'Fullstack Developer' },
    { value: 'DSA & Algorithms', label: 'DSA & Algorithms Specialist' },
  ];
    ...
    <div className="bg-white p-12 rounded-2xl">
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <label className="text-sm font-semibold text-[#374151] uppercase tracking-wider ml-1">Target Interview Role</label>
            <select 
              value={role}
              onChange={(e) => setRole(e.target.value)}
              className="w-full bg-[#F3F4F6] p-4 rounded-xl border border-[#E5E7EB] focus:outline-none focus:ring-2 focus:ring-[#14532D]/30 transition duration-300"
            >
              {roles.map((r) => (
