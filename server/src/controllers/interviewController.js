...
export const processResume = async (req, res) => {
  ...
  try {
    ...
    // UPDATE STREAK on new resume upload
    ...
    console.log('ProcessResume: Starting AI analysis (RAG-Aware, Preferred Role:', req.body.role || 'NONE', ')...');
    let analysis;
    try {
        analysis = await analyzeResume(resumeText, user._id, req.body.role);
